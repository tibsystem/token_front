...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('basic-candlestick-chart')) {
    ...
    const basicCandlestickChart = new ApexCharts(document.getElementById('basic-candlestick-chart'), basicCandlestickOptions);
  ...
  if (document.getElementById('combo-candlestick-chart')) {
    ...
    const comboCandlestickChart = new ApexCharts(document.getElementById('combo-candlestick-chart'), comboCandlestickOptions);
  ...
  if (document.getElementById('category-x-axis-candlestick-chart')) {
    ...
    const categoryXAxisOptions = {
      ...
      tooltip: {
        ...
        custom: function ({
          ...
          return '<div class="p-2">' + '<span>Month: ' + data.x + '</span><br>' + '<span>Open: $' + data.y[0] + '</span><br>' + '<span>High: $' + data.y[1] + '</span><br>' + '<span>Low: $' + data.y[2] + '</span><br>' + '<span>Close: $' + data.y[3] + '</span>' + '</div>';
        }
      },
      plotOptions: {
        candlestick: {
    ...
    const categoryXAxisChart = new ApexCharts(document.getElementById('category-x-axis-candlestick-chart'), categoryXAxisOptions);
  ...
  if (document.getElementById('candlestick-with-line-chart')) {
    ...
    const candlestickWithLineChart = new ApexCharts(document.getElementById('candlestick-with-line-chart'), candlestickWithLineOptions);
