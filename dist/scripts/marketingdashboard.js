...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const marketingPerformanceChart = new ApexCharts(document.querySelector('#marketing-profits-chart'), {
    ...
    colors: [window.colorMap.primary[300].hex, window.colorMap.warning[300].hex, window.colorMap.success[300].hex],
    stroke: {
      width: [0, 3, 3],
      curve: 'smooth'
    },
  ...
  const returningTargetChart = new ApexCharts(document.querySelector('#returning-target-chart'), {
    ...
    colors: [window.colorMap.success[200].hex,
    // New Customer (darker blue)
