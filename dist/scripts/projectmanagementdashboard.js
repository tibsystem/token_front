...
document.addEventListener('DOMContentLoaded', function () {
  ...
  // Add CSS styles for team member images in charts and tooltips
  const style = document.createElement('style');
  style.textContent = `
        /* Profile image styles for tooltip */
        .height-2 {
  ...
  if (document.getElementById('project-progress-chart')) {
    ...
    const projectProgressChartOptions = {
      ...
      fill: {
        ...
        gradient: {
          ...
          type: 'vertical',
          shadeIntensity: 0.5,
          gradientToColors: [window.colorMap.success[400].hex],
          // End color (top)
          opacityFrom: 0.8,
          ...
          colorStops: [{
            offset: 0,
            color: window.colorMap.success[100].hex || '#333333',
            // Dark color at bottom
            opacity: 0.8
          }, {
            offset: 90,
            color: window.colorMap.success[400].hex,
            // Line color in middle
            opacity: 0.2
          }]
        }
      },
    ...
    const projectProgressChart = new ApexCharts(document.getElementById('project-progress-chart'), projectProgressChartOptions);
  ...
  if (document.getElementById('task-status-chart')) {
    const taskStatusChartOptions = {
      ...
      colors: [window.colorMap.success[400].hex,
      // Completed
      window.colorMap.warning[400].hex,
      // In Progress
      window.colorMap.danger[400].hex,
      // Overdue
    ...
    const taskStatusChart = new ApexCharts(document.getElementById('task-status-chart'), taskStatusChartOptions);
  ...
  if (document.getElementById('team-performance-chart')) {
    ...
    const teamPerformanceChart = new ApexCharts(document.getElementById('team-performance-chart'), teamPerformanceChartOptions);
  ...
  if (document.getElementById('weekly-activity-chart')) {
    ...
    const weeklyActivityChart = new ApexCharts(document.getElementById('weekly-activity-chart'), weeklyActivityChartOptions);
  ...
  if (document.getElementById('team-workload-heatmap')) {
    ...
    const teamWorkloadHeatmap = new ApexCharts(document.getElementById('team-workload-heatmap'), teamWorkloadHeatmapOptions);
  ...
  if (document.getElementById('project-timeline-chart')) {
    const projectTimelineOptions = {
      ...
      colors: [window.colorMap.primary[100].hex,
      // Frontend
    ...
    const projectTimelineChart = new ApexCharts(document.getElementById('project-timeline-chart'), projectTimelineOptions);
  ...
  if (document.getElementById('development-phases-chart')) {
    ...
    const generateComplexTimelineData = () => {
      ...
      const teams = [{
        ...
        members: [{
          id: 1,
          name: 'Alex Johnson',
          img: './img/avatar-a.png'
        }, {
          id: 2,
          name: 'Emma Wilson',
          img: './img/avatar-b.png'
        }, {
          id: 3,
          name: 'Michael Chen',
          img: './img/avatar-c.png'
        }]
      }, {
        name: 'Backend Team',
        color: '#3BAFDA',
        members: [{
          id: 4,
          name: 'Sarah Williams',
          img: './img/avatar-d.png'
        }, {
          id: 5,
          name: 'James Lee',
          img: './img/avatar-e.png'
        }]
      }, {
        name: 'Database Team',
        color: '#5D9CEC',
        members: [{
          id: 6,
          name: 'Olivia Smith',
          img: './img/avatar-f.png'
        }, {
          id: 7,
          name: 'David Rodriguez',
          img: './img/avatar-g.png'
        }]
      }, {
        name: 'QA Team',
        color: '#A0D468',
        members: [{
          ...
          img: './img/avatar-h.png'
        }, {
          id: 9,
          name: 'Oliver Wilson',
          img: './img/avatar-i.png'
        }]
      }, {
        name: 'DevOps Team',
        color: '#48CFAD',
        members: [{
          id: 10,
          name: 'Jessica Brown',
          img: './img/avatar-j.png'
        }, {
          id: 11,
          name: 'Robert Taylor',
          img: './img/avatar-k.png'
        }]
      }];
      ...
      const phases = [{
        ...
        activities: [{
          ...
          name: 'Production Environment Prep',
          duration: [12, 18]
        }, {
          name: 'Data Migration',
          duration: [10, 20]
    ...
    const developmentPhasesChart = new ApexCharts(document.getElementById('development-phases-chart'), developmentPhasesOptions);
