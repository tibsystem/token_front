...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('basic-bar-chart')) {
    ...
    const basicBarChart = new ApexCharts(document.getElementById('basic-bar-chart'), basicBarOptions);
  ...
  if (document.getElementById('grouped-bar-chart')) {
    ...
    const groupedBarChart = new ApexCharts(document.getElementById('grouped-bar-chart'), groupedBarOptions);
  ...
  if (document.getElementById('stacked-bar-chart')) {
    ...
    const stackedBarChart = new ApexCharts(document.getElementById('stacked-bar-chart'), stackedBarOptions);
  ...
  if (document.getElementById('stacked-100-bar-chart')) {
    ...
    const stacked100BarChart = new ApexCharts(document.getElementById('stacked-100-bar-chart'), stacked100BarOptions);
  ...
  if (document.getElementById('grouped-stacked-bar-chart')) {
    ...
    const groupedStackedBarChart = new ApexCharts(document.getElementById('grouped-stacked-bar-chart'), groupedStackedBarOptions);
  ...
  if (document.getElementById('patterned-bar-chart')) {
    ...
    const patternedBarChart = new ApexCharts(document.getElementById('patterned-bar-chart'), patternedBarOptions);
  ...
  if (document.getElementById('negative-bar-chart')) {
    ...
    const barWithNegativeValuesChart = new ApexCharts(document.getElementById('negative-bar-chart'), barWithNegativeValuesOptions);
  ...
  if (document.getElementById('bar-with-markers-chart')) {
    ...
    const barWithMarkersChart = new ApexCharts(document.getElementById('bar-with-markers-chart'), barWithMarkersOptions);
  ...
  if (document.getElementById('reversed-bar-chart')) {
    ...
    const reversedBarChart = new ApexCharts(document.getElementById('reversed-bar-chart'), reversedBarOptions);
  ...
  if (document.getElementById('custom-datalabels-bar-chart')) {
    const customDatalabelsBarOptions = {
      ...
      colors: [window.colorMap.primary[500].hex, window.colorMap.primary[400].hex, window.colorMap.primary[300].hex, window.colorMap.primary[600].hex, window.colorMap.primary[200].hex, window.colorMap.primary[300].hex, window.colorMap.primary[400].hex, window.colorMap.primary[800].hex, window.colorMap.primary[700].hex, window.colorMap.primary[400].hex],
      dataLabels: {
        enabled: true,
        textAnchor: 'start',
        style: {
    ...
    const customDatalabelsBarChart = new ApexCharts(document.getElementById('custom-datalabels-bar-chart'), customDatalabelsBarOptions);
  ...
  if (document.getElementById('bar-with-images-chart')) {
    ...
    const barWithImagesChart = new ApexCharts(document.getElementById('bar-with-images-chart'), barWithImagesOptions);
