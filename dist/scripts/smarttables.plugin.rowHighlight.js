      ...
      const shouldHighlight = conditions.some(condition => {
        ...
        switch (condition.operator) {
          ...
          case 'between':
            ...
            return Array.isArray(condition.value) && num >= parseFloat(condition.value[0]) && num <= parseFloat(condition.value[1]);
          case 'custom':
            return typeof condition.callback === 'function' && condition.callback(cellValue, row);
          default:
            return false;
        }
      });
