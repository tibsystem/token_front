...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('basic-column-chart')) {
    ...
    const basicColumnChart = new ApexCharts(document.getElementById('basic-column-chart'), basicColumnOptions);
  ...
  if (document.getElementById('column-with-data-labels-chart')) {
    ...
    const columnWithDataLabelsChart = new ApexCharts(document.getElementById('column-with-data-labels-chart'), columnWithDataLabelsOptions);
  ...
  if (document.getElementById('stacked-column-chart')) {
    ...
    const stackedColumnChart = new ApexCharts(document.getElementById('stacked-column-chart'), stackedColumnOptions);
  ...
  if (document.getElementById('stacked-100-column-chart')) {
    ...
    const stacked100ColumnChart = new ApexCharts(document.getElementById('stacked-100-column-chart'), stacked100ColumnOptions);
  ...
  if (document.getElementById('grouped-stacked-column-chart')) {
    const groupedStackedColumnOptions = {
      ...
      xaxis: {
        categories: ['Marketing', 'Research', 'Operations', 'Sales', 'HR', 'IT'],
        labels: {
          style: {
            colors: window.colorMap.bootstrapVars.bodyColor.hex
          }
    ...
    const groupedStackedColumnChart = new ApexCharts(document.getElementById('grouped-stacked-column-chart'), groupedStackedColumnOptions);
  ...
  if (document.getElementById('column-range-chart')) {
    ...
    const columnRangeChart = new ApexCharts(document.getElementById('column-range-chart'), columnRangeOptions);
  ...
  if (document.getElementById('distributed-column-chart')) {
    const distributedColumnOptions = {
      ...
      colors: [window.colorMap.primary[500].hex, window.colorMap.primary[300].hex, window.colorMap.primary[200].hex, window.colorMap.primary[100].hex, window.colorMap.danger[500].hex, window.colorMap.danger[50].hex, window.colorMap.info[200].hex, window.colorMap.info[600].hex, window.colorMap.success[300].hex, window.colorMap.warning[300].hex],
      plotOptions: {
        bar: {
          columnWidth: '45%',
          distributed: true,
      ...
      xaxis: {
        categories: ['Team A', 'Team B', 'Team C', 'Team D', 'Team E', 'Team F', 'Team G', 'Team H', 'Team I', 'Team J'],
        labels: {
          style: {
            fontSize: '12px',
            colors: window.colorMap.bootstrapVars.bodyColor.hex
    ...
    const distributedColumnChart = new ApexCharts(document.getElementById('distributed-column-chart'), distributedColumnOptions);
  ...
  if (document.getElementById('column-with-negative-values-chart')) {
    ...
    const columnWithNegativeValuesChart = new ApexCharts(document.getElementById('column-with-negative-values-chart'), columnWithNegativeValuesOptions);
  ...
  if (document.getElementById('column-with-markers-chart')) {
    ...
    const columnWithMarkersChart = new ApexCharts(document.getElementById('column-with-markers-chart'), columnWithMarkersOptions);
  ...
  if (document.getElementById('column-with-group-label-chart')) {
    ...
    const columnWithGroupLabelChart = new ApexCharts(document.getElementById('column-with-group-label-chart'), columnWithGroupLabelOptions);
  ...
  if (document.getElementById('column-with-rotated-labels-chart')) {
    const columnWithRotatedLabelsOptions = {
      ...
      xaxis: {
        categories: ['South Korea', 'Canada', 'United Kingdom', 'France', 'Germany', 'Japan', 'Russia', 'Brazil', 'United States', 'Indonesia', 'India'],
        labels: {
          rotate: -45,
          rotateAlways: true,
          style: {
    ...
    const columnWithRotatedLabelsChart = new ApexCharts(document.getElementById('column-with-rotated-labels-chart'), columnWithRotatedLabelsOptions);
  ...
  if (document.getElementById('dynamic-loaded-column-chart')) {
    ...
    const dynamicLoadedColumnChart = new ApexCharts(document.getElementById('dynamic-loaded-column-chart'), dynamicLoadedColumnOptions);
    ...
    const dumbbellColumnOptions = {
      ...
      tooltip: {
        ...
        custom: function ({
          ...
          const max = data.y[1];
          const range = max - min;
          return '<div class="p-2">' + '<div class="mb-1"><b>' + data.x + ' Revenue Range</b></div>' + '<div>Min: $' + min.toLocaleString() + '</div>' + '<div>Max: $' + max.toLocaleString() + '</div>' + '<div>Range: $' + range.toLocaleString() + '</div>' + '</div>';
        }
      }
    };
    const dumbbellColumnChart = new ApexCharts(document.getElementById('dumbbell-column-chart'), dumbbellColumnOptions);
