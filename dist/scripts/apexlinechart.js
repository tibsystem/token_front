...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('basic-line-chart')) {
    ...
    const basicLineChart = new ApexCharts(document.getElementById('basic-line-chart'), basicLineOptions);
  ...
  if (document.getElementById('line-with-data-labels-chart')) {
    ...
    const lineWithDataLabelsChart = new ApexCharts(document.getElementById('line-with-data-labels-chart'), lineWithDataLabelsOptions);
  ...
  if (document.getElementById('multi-line-chart')) {
    ...
    const multiLineChart = new ApexCharts(document.getElementById('multi-line-chart'), multiLineOptions);
  ...
  if (document.getElementById('stepped-line-chart')) {
    ...
    const steppedLineChart = new ApexCharts(document.getElementById('stepped-line-chart'), steppedLineOptions);
  ...
  if (document.getElementById('gradient-line-chart')) {
    ...
    const gradientLineChart = new ApexCharts(document.getElementById('gradient-line-chart'), gradientLineOptions);
  ...
  if (document.getElementById('line-with-annotations-chart')) {
    const lineWithAnnotationsOptions = {
      ...
      xaxis: {
        type: 'datetime',
        categories: ['01 Nov 2021', '02 Nov 2021', '03 Nov 2021', '04 Nov 2021', '05 Nov 2021', '08 Nov 2021', '09 Nov 2021', '10 Nov 2021', '11 Nov 2021', '12 Nov 2021', '15 Nov 2021', '16 Nov 2021', '17 Nov 2021', '18 Nov 2021', '19 Nov 2021', '22 Nov 2021', '23 Nov 2021', '24 Nov 2021', '29 Nov 2021', '01 Dec 2021']
      },
      tooltip: {
        theme: 'dark',
        shared: false,
    ...
    const lineWithAnnotationsChart = new ApexCharts(document.getElementById('line-with-annotations-chart'), lineWithAnnotationsOptions);
  ...
  if (document.getElementById('dashed-line-chart')) {
    ...
    const dashedLineChart = new ApexCharts(document.getElementById('dashed-line-chart'), dashedLineOptions);
  ...
  if (document.getElementById('zoomable-timeseries-chart')) {
    ...
    const zoomableTimeseriesChart = new ApexCharts(document.getElementById('zoomable-timeseries-chart'), zoomableTimeseriesOptions);
  ...
  if (document.getElementById('annotations-line-chart')) {
    ...
    const annotationsLineChart = new ApexCharts(document.getElementById('annotations-line-chart'), annotationsLineOptions);
  ...
  if (document.getElementById('synchronized-line-chart')) {
    ...
    const syncChartOptions = {
      ...
      yaxis: {
        min: 45,
        // Set minimum value with padding
        max: 85,
        // Set maximum value with padding
        tickAmount: 5,
        labels: {
          style: {
            colors: window.colorMap.bootstrapVars.bodyColor.hex
    ...
    const syncChart = new ApexCharts(document.getElementById('synchronized-line-chart'), syncChartOptions);
    syncChart.render();
    const syncChartSmall = new ApexCharts(document.getElementById('synchronized-line-chart-small'), syncChartSmallOptions);
  ...
  if (document.getElementById('brush-line-chart')) {
    ...
    const brushChart = new ApexCharts(document.getElementById('brush-line-chart'), brushChartOptions);
    brushChart.render();
    const brushChartSmall = new ApexCharts(document.getElementById('brush-line-chart-small'), brushChartSmallOptions);
  ...
  if (document.getElementById('negative-values-line-chart')) {
    const negativeValuesOptions = {
      ...
      xaxis: {
        categories: ['Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep', 'Oct', 'Nov', 'Dec', 'Jan', 'Feb', 'Mar', 'Apr', 'May', 'Jun', 'Jul', 'Aug', 'Sep'],
        labels: {
          rotate: -90,
          style: {
            colors: window.colorMap.bootstrapVars.bodyColor.hex
    ...
    const negativeValuesChart = new ApexCharts(document.getElementById('negative-values-line-chart'), negativeValuesOptions);
  ...
  if (document.getElementById('null-values-line-chart')) {
    ...
    const nullValuesChart = new ApexCharts(document.getElementById('null-values-line-chart'), nullValuesOptions);
  ...
  if (document.getElementById('realtime-line-chart')) {
    ...
    const realtimeChart = new ApexCharts(document.getElementById('realtime-line-chart'), realtimeOptions);
  ...
  if (document.getElementById('stepline-chart')) {
    ...
    const steplineChart = new ApexCharts(document.getElementById('stepline-chart'), steplineOptions);
