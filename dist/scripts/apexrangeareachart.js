...
document.addEventListener('DOMContentLoaded', function () {
    ...
    const basicRangeAreaOptions = {
      ...
      tooltip: {
        ...
        custom: function ({
          ...
          return '<div class="p-2">' + '<span>Month: ' + data.x + '</span><br>' + '<span>Min: ' + data.y[0] + '°C</span><br>' + '<span>Max: ' + data.y[1] + '°C</span>' + '</div>';
        }
      }
    };
    const basicRangeAreaChart = new ApexCharts(document.getElementById('basic-range-area-chart'), basicRangeAreaOptions);
  ...
  if (document.getElementById('datetime-range-area-chart')) {
    ...
    const datetimeRangeAreaChart = new ApexCharts(document.getElementById('datetime-range-area-chart'), datetimeRangeAreaOptions);
  ...
  if (document.getElementById('multiple-range-area-chart')) {
    ...
    const multipleRangeAreaChart = new ApexCharts(document.getElementById('multiple-range-area-chart'), multipleRangeAreaOptions);
  ...
  if (document.getElementById('combo-range-area-chart')) {
    const comboRangeAreaOptions = {
      ...
      tooltip: {
        ...
        custom: function ({
          ...
          return '<div class="p-2">' + '<span>Month: ' + month + '</span><br>' + '<span><span style="color:#3F80EA">■</span> Min-Max Temp: ' + rangeData.y[0] + '-' + rangeData.y[1] + '°C</span><br>' + '<span><span style="color:#E63946">■</span> Avg Temp: ' + avgTemp + '°C</span><br>' + '<span><span style="color:#6D9EEB">■</span> Precipitation: ' + precip + ' mm</span>' + '</div>';
        }
      },
      legend: {
        position: 'bottom',
    ...
    const comboRangeAreaChart = new ApexCharts(document.getElementById('combo-range-area-chart'), comboRangeAreaOptions);
