...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('basic-box-whisker-chart')) {
    ...
    const basicBoxChart = new ApexCharts(document.getElementById('basic-box-whisker-chart'), basicBoxOptions);
  ...
  if (document.getElementById('horizontal-boxplot-chart')) {
    ...
    const horizontalBoxplotChart = new ApexCharts(document.getElementById('horizontal-boxplot-chart'), horizontalBoxplotOptions);
