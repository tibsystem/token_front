...
(function (window) {
  ...
  style.textContent = ['.swipe-to-delete {', '    overflow: hidden;', '    position: relative;', '    touch-action: pan-y pinch-zoom;', '}', '.swipe-to-delete li {', '    transition: transform 0.3s ease;', '    position: relative;', '}', '.swipe-to-delete li.swiping {', '    transition: none;', '}', '.swipe-to-delete li.removing {', '    transition: all 0.5s ease;', '    height: 0;', '    padding-top: 0;', '    padding-bottom: 0;', '    margin-top: 0;', '    margin-bottom: 0;', '    opacity: 0;', '}', '.swipe-action {', '    position: absolute;', '    top: 0;', '    height: 100%;', '    display: flex;', '    align-items: center;', '    padding: 0 20px;', '    color: white;', '    font-weight: bold;', '    opacity: 0;', '    transition: opacity 0.3s ease;', '}', '.swipe-action.left {', '    right: 0;', '    background: #dc3545;', '}', '.swipe-action.right {', '    left: 0;', '    background: #28a745;', '}'].join('\n');
