...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('line-column-chart')) {
    ...
    const lineColumnChart = new ApexCharts(document.getElementById('line-column-chart'), lineColumnOptions);
  ...
  if (document.getElementById('multiple-y-axis-chart')) {
    ...
    const multipleYAxisChart = new ApexCharts(document.getElementById('multiple-y-axis-chart'), multipleYAxisOptions);
  ...
  if (document.getElementById('line-area-chart')) {
    ...
    const lineAreaChart = new ApexCharts(document.getElementById('line-area-chart'), lineAreaOptions);
  ...
  if (document.getElementById('line-column-area-chart')) {
    ...
    const lineColumnAreaChart = new ApexCharts(document.getElementById('line-column-area-chart'), lineColumnAreaOptions);
  ...
  if (document.getElementById('candlestick-line-chart')) {
    ...
    const candlestickLineChart = new ApexCharts(document.getElementById('candlestick-line-chart'), candlestickLineOptions);
  ...
  if (document.getElementById('line-scatter-chart')) {
    ...
    const lineScatterChart = new ApexCharts(document.getElementById('line-scatter-chart'), lineScatterOptions);
