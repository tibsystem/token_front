...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('simple-bubble-chart')) {
    ...
    const simpleBubbleChart = new ApexCharts(document.getElementById('simple-bubble-chart'), simpleBubbleOptions);
  ...
  if (document.getElementById('3d-bubble-chart')) {
    ...
    const bubbleChart3d = new ApexCharts(document.getElementById('3d-bubble-chart'), bubbleChart3dOptions);
