...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('subscription-chart')) {
    ...
    const subscriptionChartOptions = {
      ...
      colors: [window.colorMap.bootstrapVars.bodyColor.rgba(0.1),
      // Visits (gray, area)
    ...
    const subscriptionChart = new ApexCharts(document.getElementById('subscription-chart'), subscriptionChartOptions);
  ...
  if (document.getElementById('user-activity-chart')) {
    ...
    const userActivityChart = new ApexCharts(document.getElementById('user-activity-chart'), userActivityChartOptions);
  ...
  if (document.getElementById('data-stream-chart')) {
    ...
    const dataStreamChart = new ApexCharts(document.getElementById('data-stream-chart'), dataStreamChartOptions);
  ...
  if (document.getElementById('demographic-marketing-chart')) {
    ...
    const demographicMarketingChartOptions = {
      ...
      // Germany (darker purple)
      window.colorMap.success[100].hex,
    ...
    const demographicMarketingChart = new ApexCharts(document.getElementById('demographic-marketing-chart'), demographicMarketingChartOptions);
      ...
      switch (this.value) {
        case 'acquisition':
          ...
          offerRadios.forEach(radio => {
            if (radio.value === 'freeTrial') radio.checked = true;else radio.checked = false;
          });
        ...
        case 'retention':
          ...
          offerRadios.forEach(radio => {
            if (radio.value === 'discount') radio.checked = true;else radio.checked = false;
          });
          // Trigger change to update visibility
        ...
        case 'upgrade':
          ...
          offerRadios.forEach(radio => {
            if (radio.value === 'upgrade') radio.checked = true;else radio.checked = false;
          });
          // Trigger change to update visibility
        ...
        case 'winback':
          ...
          offerRadios.forEach(radio => {
            if (radio.value === 'bundle') radio.checked = true;else radio.checked = false;
          });
          // Trigger change to update visibility
  ...
  document.querySelectorAll('input[name="offerType"]').forEach(radio => {
    radio.addEventListener('change', function () {
      document.getElementById('discountSection').style.display = this.value === 'discount' ? 'block' : 'none';
    });
  });
