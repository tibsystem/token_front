...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function getEmailProviderIcon(email) {
    ...
    switch (domain) {
      ...
      // Microsoft icon for Hotmail/Outlook
      case 'gmail':
        return 'fab fa-google';
      // Google icon for Gmail
      case 'yahoo':
        return 'fab fa-yahoo';
      // Yahoo icon for Yahoo
      default:
        return 'fas fa-envelope';
      // Default email icon for other providers
    }
  }
  ...
  const table = new SmartTables('myTable', {
    ...
    responsive: {
      ...
      columnPriorities: {
        0: 1,
        // ID - highest priority (never hide)
        1: 2,
        // First Name - second highest priority
        2: 3,
        // Last Name - third priority
        3: 4,
        // Gender - fourth priority
        4: 5,
        // Phone - fifth priority
      ...
      afterDraw: function () {
        ...
        popoverElements.forEach(element => {
          ...
          new bootstrap.Popover(element, {
            placement: 'top',
            // Forces the popover to appear on top
            trigger: 'hover',
            // Ensures popover appears on hover
