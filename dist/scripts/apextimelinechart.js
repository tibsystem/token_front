...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('basic-timeline-chart')) {
    ...
    const basicTimelineChart = new ApexCharts(document.getElementById('basic-timeline-chart'), basicTimelineOptions);
  ...
  if (document.getElementById('custom-colors-timeline-chart')) {
    const customColorsTimelineOptions = {
      series: [{
        data: [{
          x: 'Research',
          y: [new Date('2019-03-01').getTime(), new Date('2019-03-05').getTime()],
          ...
          x: 'Development',
          y: [new Date('2019-03-09').getTime(), new Date('2019-03-15').getTime()],
          fillColor: window.colorMap.warning[600].hex
        }, {
          x: 'Testing',
          y: [new Date('2019-03-15').getTime(), new Date('2019-03-20').getTime()],
          fillColor: window.colorMap.danger[600].hex
        }, {
          x: 'Deployment',
          y: [new Date('2019-03-20').getTime(), new Date('2019-03-25').getTime()],
    ...
    const customColorsTimelineChart = new ApexCharts(document.getElementById('custom-colors-timeline-chart'), customColorsTimelineOptions);
  ...
  if (document.getElementById('multi-series-timeline-chart')) {
    const multiSeriesTimelineOptions = {
      series: [{
        ...
        data: [{
          ...
          x: 'Code',
          y: [new Date('2019-03-06').getTime(), new Date('2019-03-15').getTime()]
        }, {
          x: 'Test',
        ...
        data: [{
          ...
          x: 'QA Testing',
          y: [new Date('2019-03-14').getTime(), new Date('2019-03-25').getTime()]
        }, {
          x: 'User Testing',
          y: [new Date('2019-03-20').getTime(), new Date('2019-03-28').getTime()]
        }]
      }],
      chart: {
        height: 350,
    ...
    const multiSeriesTimelineChart = new ApexCharts(document.getElementById('multi-series-timeline-chart'), multiSeriesTimelineOptions);
  ...
  if (document.getElementById('advanced-timeline-chart')) {
    ...
    const advancedTimelineChart = new ApexCharts(document.getElementById('advanced-timeline-chart'), advancedTimelineOptions);
    ...
    const multipleSeriesGroupTimelineOptions = {
      series: [{
        ...
        data: [{
          ...
          x: 'Development',
          y: [new Date('2019-03-08').getTime(), new Date('2019-03-20').getTime()]
        }, {
          x: 'Testing',
          y: [new Date('2019-03-20').getTime(), new Date('2019-03-28').getTime()]
        }]
        ...
        data: [{
          x: 'API Design',
          y: [new Date('2019-03-01').getTime(), new Date('2019-03-10').getTime()]
        }, {
          x: 'Implementation',
          y: [new Date('2019-03-10').getTime(), new Date('2019-03-22').getTime()]
        }, {
          x: 'Integration Testing',
          y: [new Date('2019-03-22').getTime(), new Date('2019-04-05').getTime()]
        }]
      }, {
        name: 'Database',
        data: [{
          x: 'Schema Design',
          y: [new Date('2019-03-05').getTime(), new Date('2019-03-12').getTime()]
        }, {
          x: 'Data Migration',
          y: [new Date('2019-03-15').getTime(), new Date('2019-03-25').getTime()]
        }, {
          x: 'Performance Testing',
          y: [new Date('2019-03-25').getTime(), new Date('2019-04-10').getTime()]
        }]
      }],
      chart: {
        height: 350,
      ...
      tooltip: {
        ...
        custom: function ({
          ...
          return '<div class="p-2">' + '<div><b>' + w.globals.initialSeries[seriesIndex].name + ': ' + task.x + '</b></div>' + '<div>Start: ' + formatDate(from) + '</div>' + '<div>End: ' + formatDate(to) + '</div>' + '</div>';
        }
      },
      colors: [window.colorMap.primary[500].hex, window.colorMap.primary[400].hex, window.colorMap.primary[100].hex]
    };
    const multipleSeriesGroupTimelineChart = new ApexCharts(document.getElementById('multiple-series-group-timeline-chart'), multipleSeriesGroupTimelineOptions);
  ...
  if (document.getElementById('dumbbell-timeline-chart')) {
    const dumbbellTimelineOptions = {
      series: [{
        data: [{
          x: 'Project A',
          y: [new Date('2019-01-01').getTime(), new Date('2019-03-15').getTime()]
        }, {
          x: 'Project B',
          y: [new Date('2019-02-15').getTime(), new Date('2019-06-01').getTime()]
        }, {
          x: 'Project C',
          y: [new Date('2019-04-01').getTime(), new Date('2019-08-15').getTime()]
        }, {
          x: 'Project D',
          y: [new Date('2019-05-15').getTime(), new Date('2019-09-01').getTime()]
        }, {
          x: 'Project E',
          y: [new Date('2019-07-01').getTime(), new Date('2019-12-31').getTime()]
        }]
      }],
      chart: {
        height: 350,
    ...
    const dumbbellTimelineChart = new ApexCharts(document.getElementById('dumbbell-timeline-chart'), dumbbellTimelineOptions);
