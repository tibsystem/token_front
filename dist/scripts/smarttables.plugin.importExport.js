...
export const ImportExportPlugin = {
  ...
  init() {
    ...
    if (existingToolbar) {
      ...
      if (this.instance.wrapper) {
        observer.observe(this.instance.wrapper, {
          childList: true,
          subtree: true
        });
  ...
  setupExportUI() {
    ...
    const exportCol = this.instance.toolbar.querySelector('.col-12.d-flex.justify-content-end') || this.instance.toolbar.querySelector('.col.d-flex.justify-content-end') || this.instance.toolbar.querySelector('.d-flex.justify-content-end') || this.instance.toolbar.querySelector('[class*="justify-content-end"]');
    if (!exportCol) {
