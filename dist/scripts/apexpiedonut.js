...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('simple-pie-chart')) {
    ...
    const simplePieChart = new ApexCharts(document.getElementById('simple-pie-chart'), simplePieOptions);
  ...
  if (document.getElementById('simple-donut-chart')) {
    ...
    const simpleDonutChart = new ApexCharts(document.getElementById('simple-donut-chart'), simpleDonutOptions);
  ...
  if (document.getElementById('donut-update-chart')) {
    ...
    const donutUpdateChart = new ApexCharts(document.getElementById('donut-update-chart'), donutUpdateOptions);
    ...
    document.getElementById('donut-update-chart').addEventListener('click', function () {
      ...
      donutUpdateChart.updateSeries([Math.floor(Math.random() * 91) + 10, Math.floor(Math.random() * 91) + 10, Math.floor(Math.random() * 91) + 10, Math.floor(Math.random() * 91) + 10]);
    });
  }
  ...
  if (document.getElementById('monochrome-pie-chart')) {
    ...
    const monochromePieChart = new ApexCharts(document.getElementById('monochrome-pie-chart'), monochromePieOptions);
  ...
  if (document.getElementById('gradient-donut-chart')) {
    ...
    const gradientDonutChart = new ApexCharts(document.getElementById('gradient-donut-chart'), gradientDonutOptions);
  ...
  if (document.getElementById('donut-with-pattern-chart')) {
    const patternDonutOptions = {
      ...
      colors: [window.colorMap.primary[500].hex, window.colorMap.info[500].hex, window.colorMap.success[500].hex, window.colorMap.danger[500].hex, window.colorMap.warning[500].hex],
      title: {
    ...
    const patternDonutChart = new ApexCharts(document.getElementById('donut-with-pattern-chart'), patternDonutOptions);
  ...
  if (document.getElementById('basic-pie-chart')) {
    ...
    const basicPieChart = new ApexCharts(document.getElementById('basic-pie-chart'), basicPieOptions);
  ...
  if (document.getElementById('pie-with-labels-chart')) {
    ...
    const pieWithLabelsChart = new ApexCharts(document.getElementById('pie-with-labels-chart'), pieWithLabelsOptions);
  ...
  if (document.getElementById('basic-donut-chart')) {
    ...
    const basicDonutChart = new ApexCharts(document.getElementById('basic-donut-chart'), basicDonutOptions);
  ...
  if (document.getElementById('donut-pattern-chart')) {
    ...
    const donutPatternChart = new ApexCharts(document.getElementById('donut-pattern-chart'), donutPatternOptions);
  ...
  if (document.getElementById('semi-donut-chart')) {
    ...
    const semiDonutChart = new ApexCharts(document.getElementById('semi-donut-chart'), semiDonutOptions);
  ...
  if (document.getElementById('pie-with-image-chart')) {
    const pieWithImageOptions = {
      ...
      fill: {
        ...
        opacity: 0.85,
        image: {
          src: ['img/beef.webp', 'img/cake.webp', 'img/cheese.webp', 'img/chips.webp'],
          width: 150,
          height: 150
        }
      },
    ...
    const pieWithImageChart = new ApexCharts(document.getElementById('pie-with-image-chart'), pieWithImageOptions);
