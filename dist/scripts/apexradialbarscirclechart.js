...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('basic-radialbar-chart')) {
    ...
    const basicRadialbarChart = new ApexCharts(document.getElementById('basic-radialbar-chart'), basicRadialbarOptions);
  ...
  if (document.getElementById('multiple-radialbar-chart')) {
    ...
    const multipleRadialbarChart = new ApexCharts(document.getElementById('multiple-radialbar-chart'), multipleRadialbarOptions);
  ...
  if (document.getElementById('custom-angle-circle-chart')) {
    ...
    const customAngleChart = new ApexCharts(document.getElementById('custom-angle-circle-chart'), customAngleOptions);
  ...
  if (document.getElementById('gradient-radialbar-chart')) {
    ...
    const gradientRadialbarChart = new ApexCharts(document.getElementById('gradient-radialbar-chart'), gradientRadialbarOptions);
  ...
  if (document.getElementById('radialbar-with-image-chart')) {
    ...
    const radialbarWithImageChart = new ApexCharts(document.getElementById('radialbar-with-image-chart'), radialbarWithImageOptions);
  ...
  if (document.getElementById('stroked-gauge-chart')) {
    ...
    const strokedGaugeChart = new ApexCharts(document.getElementById('stroked-gauge-chart'), strokedGaugeOptions);
  ...
  if (document.getElementById('semi-circle-gauge-chart')) {
    ...
    const semiCircleGaugeChart = new ApexCharts(document.getElementById('semi-circle-gauge-chart'), semiCircleGaugeOptions);
