...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('basic-slope-chart')) {
    ...
    const basicSlopeChart = new ApexCharts(document.getElementById('basic-slope-chart'), basicSlopeOptions);
  ...
  if (document.getElementById('multi-group-slope-chart')) {
    ...
    const multiGroupSlopeChart = new ApexCharts(document.getElementById('multi-group-slope-chart'), multiGroupSlopeOptions);
