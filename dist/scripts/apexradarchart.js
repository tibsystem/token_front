...
document.addEventListener('DOMContentLoaded', function () {
  ...
  if (document.getElementById('basic-radar-chart')) {
    ...
    const basicRadarChart = new ApexCharts(document.getElementById('basic-radar-chart'), basicRadarOptions);
  ...
  if (document.getElementById('multi-series-radar-chart')) {
    ...
    const multiSeriesRadarChart = new ApexCharts(document.getElementById('multi-series-radar-chart'), multiSeriesRadarOptions);
  ...
  if (document.getElementById('polygon-fill-radar-chart')) {
    ...
    const polygonFillRadarChart = new ApexCharts(document.getElementById('polygon-fill-radar-chart'), polygonFillRadarOptions);
