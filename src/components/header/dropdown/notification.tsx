  ...
  return (
    <div className="navbar-item dropdown">
      ...
      <div className="dropdown-menu media-list dropdown-menu-end">
        ...
        <a href="#" className="dropdown-item media">
          <div className="media-left">
            <Image src="/assets/img/user/user-1.jpg" width="48" height="48" className="media-object" alt="" />
        ...
        <a href="#" className="dropdown-item media">
          <div className="media-left">
            <Image src="/assets/img/user/user-2.jpg" width="48" height="48" className="media-object" alt="" />
            <i className="fab fa-facebook-messenger text-blue media-object-icon"></i>
          </div>
          <div className="media-body">
        ...
        <a href="#" className="dropdown-item media">
          ...
          <div className="media-body">
            ...
            <div className="text-muted fs-10px">2 hours ago</div>
          </div>
        </a>
