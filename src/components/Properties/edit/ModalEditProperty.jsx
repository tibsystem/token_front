  ...
  (
    ...
    useEffect(() => {
      if (Attachments.length > 0 && showEditModal) {
        setAttachedFiles(
          Attachments.filter(
            (doc) => !removedAttachmentIds.includes(doc.id)
          ).map((doc) => ({
            id: doc.id,
            url: doc.path,
            name: doc.name,
    ...
    const handleFileDescriptionChange = (index, value) => {
      setAttachedFiles((prev) =>
        prev.map((doc, i) =>
          i === index ? { ...doc, description: value } : doc
        )
      );
    };
                                ...
                                <div className="d-flex align-items-center gap-3 mb-2">
                                  ...
                                  <div className="flex-grow-1">
                                    ...
                                    <small className="text-muted">
                                      {(attached.size / 1024 / 1024).toFixed(2)}{" "}
                                      MB
                                    </small>
                                  </div>
                                  <button
            ...
            <div className="mb-3 row">
              <div className="col-md-12">
                <div className="p-3 rounded-3 ">
                  <h6 className="text-dark text-center fs-5 mb-2 fw-bold">
                    Selecione o nivel de Garantia
                  </h6>
                  <p className="text-center fs-6 mb-2 ">
                    Esse investimento será classificado no{" "}
                    <strong>Nível {editFormData.level_warrant || 1}</strong>
                  </p>
                  <div className="d-flex gap-2 align-items-end">
                    {[1, 2, 3, 4, 5].map((nivel, idx) => {
                      ...
                      const nivelAtual =
                        Number(editFormData.level_warrant) || 1;
                      return (
                        <div
                          key={nivel}
                          ...
                          onClick={() =>
                            handleInputChange({
                              target: { name: "level_warrant", value: nivel },
                            })
                          }
                        >
                          <div
              ...
              <div className="col-md-12">
                  ...
                  <div className="alert alert-warning mt-2" role="alert">
                    Atenção: Tokenizar a propriedade é uma ação{" "}
