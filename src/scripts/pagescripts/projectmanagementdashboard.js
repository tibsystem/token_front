        ...
        const generateComplexTimelineData = () => {
            ...
            const teams = [
                { 
                    ...
                    color: '#4A89DC',
                    members: [
                        { id: 1, name: 'Alex Johnson', img: './img/avatar-a.png' },
                        { id: 2, name: 'Emma Wilson', img: './img/avatar-b.png' },
                        { id: 3, name: 'Michael Chen', img: './img/avatar-c.png' }
                    ] 
                },
                { 
                    name: 'Backend Team', 
                    color: '#3BAFDA',
                    members: [
                        { id: 4, name: 'Sarah Williams', img: './img/avatar-d.png' },
                        { id: 5, name: 'James Lee', img: './img/avatar-e.png' }
                    ] 
                },
                { 
                    name: 'Database Team', 
                    color: '#5D9CEC',
                    members: [
                        { id: 6, name: 'Olivia Smith', img: './img/avatar-f.png' },
                        { id: 7, name: 'David Rodriguez', img: './img/avatar-g.png' }
                    ] 
                },
                { 
                    name: 'QA Team', 
                    color: '#A0D468',
                    members: [
                        { id: 8, name: 'Sophia Martinez', img: './img/avatar-h.png' },
                        { id: 9, name: 'Oliver Wilson', img: './img/avatar-i.png' }
                    ] 
                },
                { 
                    name: 'DevOps Team', 
                    color: '#48CFAD',
                    members: [
                        { id: 10, name: 'Jessica Brown', img: './img/avatar-j.png' },
                        { id: 11, name: 'Robert Taylor', img: './img/avatar-k.png' }
                    ] 
                }
            ];
