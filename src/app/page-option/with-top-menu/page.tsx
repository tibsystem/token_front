...
export default function PageOptionWithTopMenu() {
	...
	useEffect(() => {
  	...
  	const { signal } = controller;
		const fetchData = async (index: number) => {
			try {
				const response = await fetch(`/assets/data/page-option/with-top-menu-code-${index}.json`, { signal });
	...
	return (
        ...
        <li className="breadcrumb-item"><Link href="/page-option/with-top-menu">Home</Link></li>
        <li className="breadcrumb-item"><Link href="/page-option/with-top-menu">Page Options</Link></li>
