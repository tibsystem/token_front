...
export default function PageOptionWithMegaMenu() {
	...
	useEffect(() => {
  	...
  	const { signal } = controller;
		const fetchData = async (index: number) => {
			try {
				const response = await fetch(`/assets/data/page-option/with-mega-menu-code-${index}.json`, { signal });
	...
	return (
        ...
        <li className="breadcrumb-item"><Link href="/page-option/with-mega-menu">Home</Link></li>
        <li className="breadcrumb-item"><Link href="/page-option/with-mega-menu">Page Options</Link></li>
