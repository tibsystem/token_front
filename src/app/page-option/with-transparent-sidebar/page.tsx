...
export default function PageOptionWithTransparentSidebar() {
	...
	useEffect(() => {
  	...
  	const { signal } = controller;
		const fetchData = async (index: number) => {
			try {
				const response = await fetch(`/assets/data/page-option/with-transparent-sidebar-code-${index}.json`, { signal });
	...
	return (
      ...
      <ol className="breadcrumb float-xl-end">
        <li className="breadcrumb-item"><Link href="/page-option/with-transparent-sidebar">Home</Link></li>
        <li className="breadcrumb-item"><Link href="/page-option/with-transparent-sidebar">Page Options</Link></li>
