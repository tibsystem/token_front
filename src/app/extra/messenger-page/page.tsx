...
export default function ExtraMessengerPage() {
			...
			<div className="messenger-menu">
				<div className="messenger-menu-item my-2">
					<a href="#/" className="messenger-menu-link">
						<div className="m-n1">
							<Image alt="" src="/assets/img/user/user-13.jpg" width="37" height="37" className="w-100 d-block rounded-circle" />
						</div>
					</a>
				</div>
							...
							<div className="messenger-chat-item">
								<a href="#/" className="messenger-chat-link" onClick={handleMobileSidebarToggle}>
									<div className="messenger-chat-media">
										<Image alt="" width="44" height="44" src="/assets/img/user/user-1.jpg" />
									</div>
							...
							<div className="messenger-chat-item active">
								<a href="#/" className="messenger-chat-link" onClick={handleMobileSidebarToggle}>
									<div className="messenger-chat-media flex-wrap overflow-hidden">
										<Image alt="" src="/assets/img/user/user-1.jpg" width="14" height="14" className="rounded-0 me-1px mb-1px" />
										<Image alt="" src="/assets/img/user/user-2.jpg" width="14" height="14" className="rounded-0 me-1px mb-1px" />
										<Image alt="" src="/assets/img/user/user-3.jpg" width="14" height="14" className="rounded-0 me-0px mb-1px" />
										<Image alt="" src="/assets/img/user/user-4.jpg" width="14" height="14" className="rounded-0 me-1px mb-1px" />
										<Image alt="" src="/assets/img/user/user-5.jpg" width="14" height="14" className="rounded-0 me-1px mb-1px" />
										<Image alt="" src="/assets/img/user/user-6.jpg" width="14" height="14" className="rounded-0 me-0px mb-1px" />
										<Image alt="" src="/assets/img/user/user-7.jpg" width="14" height="14" className="rounded-0 me-1px mb-1px" />
										<Image alt="" src="/assets/img/user/user-8.jpg" width="14" height="14" className="rounded-0 me-1px mb-1px" />
										<Image alt="" src="/assets/img/user/user-9.jpg" width="14" height="14" className="rounded-0 me-0px mb-1px" />
									</div>
									<div className="messenger-chat-content">
										<div className="messenger-chat-title">
								...
								<a href="#/" className="messenger-chat-link" onClick={handleMobileSidebarToggle}>
									<div className="messenger-chat-media row gx-0 overflow-hidden">
										<div className="col-6 d-flex flex-column">
											<Image alt="" src="/assets/img/user/user-10.jpg" width="22" height="22" className="w-100 rounded-0" />
											<Image alt="" src="/assets/img/user/user-11.jpg" width="22" height="22" className="w-100 rounded-0" />
										</div>
										<div className="col-6 d-flex flex-column">
											<Image alt="" src="/assets/img/user/user-12.jpg" width="22" height="22" className="w-100 rounded-0" />
											<Image alt="" src="/assets/img/user/user-13.jpg" width="22" height="22" className="w-100 rounded-0" />
										</div>
									</div>
									<div className="messenger-chat-content">
										<div className="messenger-chat-title">
					...
					<PerfectScrollbar className="widget-chat-body h-100">
						<div className="widget-chat-item with-media end">
							<div className="widget-chat-media">
								<Image alt="" width="38" height="38" src="/assets/img/user/user-13.jpg" />
							</div>
						...
						<div className="widget-chat-item with-media start">
							<div className="widget-chat-media">
								<Image alt="" width="38" height="38" src="/assets/img/user/user-1.jpg" />
							</div>
							<div className="widget-chat-info">
								<div className="widget-chat-info-container">
						...
						<div className="widget-chat-item with-media start">
							<div className="widget-chat-media">
								<Image alt="" width="38" height="38" src="/assets/img/user/user-2.jpg" />
							</div>
							<div className="widget-chat-info">
								<div className="widget-chat-info-container">
						...
						<div className="widget-chat-item with-media start">
							<div className="widget-chat-media">
								<Image alt="" width="38" height="38" src="/assets/img/user/user-3.jpg" />
							</div>
							<div className="widget-chat-info">
								<div className="widget-chat-info-container">
						...
						<div className="widget-chat-item with-media start">
							<div className="widget-chat-media">
								<Image alt="" width="38" height="38" src="/assets/img/user/user-4.jpg" />
							</div>
							<div className="widget-chat-info">
								<div className="widget-chat-info-container">
									<div className="widget-chat-name text-blue">Daniel</div>
