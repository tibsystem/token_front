...
export default function ExtraProfile() {
				...
				<div className="profile-header">
					...
					<div className="profile-header-content">
						<div className="profile-header-img">
							<Image width="128" height="128" className="h-auto" src="/assets/img/user/user-13.jpg" alt="" />
						</div>
					...
					<div className="tab-pane fade show active" id="profile-post">
						<div className="timeline">
							<div className="timeline-item">
								...
								<div className="timeline-content">
									<div className="timeline-header">
										<div className="userimage"><Image width="40" height="40" src="/assets/img/user/user-1.jpg" alt="" /></div>
									...
									<div className="timeline-body">
										...
										<form action="" className="d-flex align-items-center">
											<div><Image width="35" height="35" src="/assets/img/user/user-13.jpg" alt="" className="rounded-pill" /></div>
							...
							<div className="timeline-item">
								...
								<div className="timeline-content">
									<div className="timeline-header">
										<div className="userimage"><Image width="40" height="40" src="/assets/img/user/user-2.jpg" alt="" /></div>
										<div className="username">
							...
							<div className="timeline-item">
								...
								<div className="timeline-content">
									<div className="timeline-header">
										<div className="userimage"><Image width="40" height="40" src="/assets/img/user/user-3.jpg" alt="" /></div>
										<div className="username">
							...
							<div className="timeline-item">
								...
								<div className="timeline-content">
									<div className="timeline-header">
										<div className="userimage"><Image width="40" height="40" src="/assets/img/user/user-4.jpg" alt="" /></div>
										<div className="username">
									...
									<div className="timeline-body">
										<div className="mb-3">
											...
											<div className="row gx-1">
												<div className="col-6">
													<a href="/assets/img/gallery/gallery-4.jpg" data-lity><Image width="1280" height="800" src="/assets/img/gallery/gallery-4.jpg" alt="" className="mw-100 d-block h-auto" /></a>
												</div>
												<div className="col-6">
													<a href="/assets/img/gallery/gallery-5.jpg" data-lity><Image width="1280" height="800" src="/assets/img/gallery/gallery-5.jpg" alt="" className="mw-100 d-block h-auto" /></a>
												</div>
											</div>
										</div>
						...
						<div className="row gx-1">
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=RQ5ljyGg-ig" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/RQ5ljyGg-ig/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=5lWkZ-JaEOc" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/5lWkZ-JaEOc/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=9ZfN87gSjvI" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/9ZfN87gSjvI/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=w2H07DRv2_M" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/w2H07DRv2_M/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=PntG8KEVjR8" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/PntG8KEVjR8/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=q8kxKvSQ7MI" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/q8kxKvSQ7MI/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=cutu3Bw4ep4" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/cutu3Bw4ep4/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=gCspUXGrraM" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/gCspUXGrraM/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=COtpTM1MpAA" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/COtpTM1MpAA/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=8NVkGHVOazc" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/8NVkGHVOazc/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=ZtT3jaTcCsY" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/ZtT3jaTcCsY/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=Dmw0ucCv8aQ" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/Dmw0ucCv8aQ/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=r1d7ST2TG2U" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/r1d7ST2TG2U/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=WUR-XWBcHvs" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/WUR-XWBcHvs/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=A7sQ8RWj0Cw" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/A7sQ8RWj0Cw/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
							<div className="col-md-3 col-sm-4 mb-1">
								<a href="https://www.youtube.com/watch?v=IMN2VfiXls4" data-lity>
									<Image width="320" height="180" src="https://img.youtube.com/vi/IMN2VfiXls4/mqdefault.jpg" alt="" className="d-block w-100 h-auto" />
								</a>
							</div>
						</div>
					</div>
						...
						<div className="row gx-1">
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-1.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
							...
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-2.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
									<div className="flex-1 ps-3">
							...
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-3.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
									<div className="flex-1 ps-3">
							...
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-4.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
									<div className="flex-1 ps-3">
							...
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-5.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
									<div className="flex-1 ps-3">
							...
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-6.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
									<div className="flex-1 ps-3">
							...
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-7.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
									<div className="flex-1 ps-3">
							...
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-8.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
									<div className="flex-1 ps-3">
							...
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-9.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
									<div className="flex-1 ps-3">
							...
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-10.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
									<div className="flex-1 ps-3">
							...
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-11.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
									<div className="flex-1 ps-3">
							...
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-12.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
									<div className="flex-1 ps-3">
							...
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-13.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
									<div className="flex-1 ps-3">
							...
							<div className="col-xl-4 col-lg-6 mb-1">
								<div className="p-2 d-flex align-items-center card flex-row border-0 rounded">
									<a href="#/">
										<Image src="/assets/img/user/user-14.jpg" alt="" className="rounded" width="64" height="64" />
									</a>
									<div className="flex-1 ps-3">
