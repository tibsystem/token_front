...
export default function FormElements() {
	const initialState: (string | undefined)[] = Array(14).fill(undefined);
    ...
    const controller = new AbortController();
  	const { signal } = controller;
		const fetchData = async (index: number) => {
			try {
				const response = await fetch(`/assets/data/form/element-code-${index}.json`, { signal });
	...
	return (
		<>
			<ol className="breadcrumb float-xl-end">
				<li className="breadcrumb-item"><Link href="/form/elements">Home</Link></li>
				<li className="breadcrumb-item"><Link href="/form/elements">Form Stuff</Link></li>
						...
						<PanelBody>
							...
							<div className="input-group">
								...
								<div className="dropdown-menu">
									<Link href="/form/elements" className="dropdown-item">Action</Link>
									<Link href="/form/elements" className="dropdown-item">Another action</Link>
									<Link href="/form/elements" className="dropdown-item">Something else here</Link>
									<div className="dropdown-divider"></div>
									<Link href="/form/elements" className="dropdown-item">Separated link</Link>
								</div>
								<input type="text" className="form-control" />
