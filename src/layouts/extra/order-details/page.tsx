...
export default function ExtraOrderDetails() {
	return (
		<>
					...
					<div className="card border-0 mb-4">
						...
						<div className="card-body p-3 text-dark fw-bold">
							<div className="row align-items-center">
								<div className="col-lg-8 d-flex align-items-center">
									<div className="h-65px w-65px d-flex align-items-center justify-content-center position-relative">
										<Image src="/assets/img/product/product-1.jpg" width="300" height="288" alt="" className="mw-100 mh-100 w-auto h-auto" />
							...
							<div className="row">
								<div className="col-lg-8 d-flex align-items-center">
									<div className="h-65px w-65px d-flex align-items-center justify-content-center position-relative">
										<Image src="/assets/img/product/product-2.jpg" width="300" height="306" alt="" className="mw-100 mh-100 w-auto h-auto" />
										<span className="w-20px h-20px p-0 d-flex align-items-center justify-content-center badge bg-primary text-white position-absolute end-0 top-0 fw-bold fs-12px rounded-pill mt-n2 me-n2">1</span>
									</div>
									<div className="ps-3 flex-1">
							...
							<div className="row">
								<div className="col-lg-8 d-flex align-items-center">
									<div className="h-65px w-65px d-flex align-items-center justify-content-center position-relative">
										<Image src="/assets/img/product/product-3.jpg" width="300" height="442" alt="" className="mw-100 mh-100 w-auto h-auto" />
										<span className="w-20px h-20px p-0 d-flex align-items-center justify-content-center badge bg-primary text-white position-absolute end-0 top-0 fw-bold fs-12px rounded-pill mt-n2 me-n2">1</span>
									</div>
									<div className="ps-3 flex-1">
						...
						<div className="card-body">
							<table className="table table-borderless table-sm fw-bold m-0">
								<tbody>
									...
									<tr>
										<td>Shipping Fee</td>
										<td>promo code: <u className="text-success">FREESHIPPING</u> (<s>$120.00</s>)</td>
				...
				<div className="col-xl-4">
					...
					<div className="card border-0 mb-4">
						...
						<div className="card-body fw-bold">
							<div className="d-flex align-items-center">
								<a href="#/" className="d-block"><Image src="/assets/img/user/user-1.jpg" alt="" width="45" height="45" className="rounded-pill" /></a>
