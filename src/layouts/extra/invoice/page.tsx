...
export default function ExtraInvoice() {
	...
	return (
		<>
			<ol className="breadcrumb hidden-print float-xl-end">
				<li className="breadcrumb-item"><Link href="/extra/invoice">Home</Link></li>
			...
			<div className="invoice">
				<div className="invoice-company">
					<span className="float-end hidden-print">
						<button className="btn btn-sm btn-white mb-10px me-2"><i className="fa fa-file-pdf t-plus-1 text-danger fa-fw fa-lg"></i> Export as PDF</button>
						<button onClick={print} className="btn btn-sm btn-white mb-10px"><i className="fa fa-print t-plus-1 fa-fw fa-lg"></i> Print</button>
					</span>
					Company Name, Inc
				</div>
						...
						<table className="table table-invoice">
							<thead>
								<tr>
									...
									<th className="text-end" style={{ width: "20%" }}>LINE TOTAL</th>
								</tr>
							</thead>
							<tbody>
								<tr>
