...
export default function ExtraTimeline() {
	useEffect(() => {
		...
		<>
			...
			<div className="timeline">
				<div className="timeline-item">
					...
					<div className="timeline-content">
						<div className="timeline-header">
							<div className="userimage"><Image src="/assets/img/user/user-1.jpg" width="40" height="40" alt="" /></div>
						...
						<div className="timeline-body">
							...
							<form action="" className="d-flex align-items-center">
								<div><Image src="/assets/img/user/user-13.jpg" width="40" height="40" alt="" className="rounded-pill" /></div>
				...
				<div className="timeline-item">
					...
					<div className="timeline-content">
						<div className="timeline-header">
							<div className="userimage"><Image src="/assets/img/user/user-2.jpg" width="40" height="40" alt="" /></div>
							<div className="username">
				...
				<div className="timeline-item">
					...
					<div className="timeline-content">
						<div className="timeline-header">
							<div className="userimage"><Image src="/assets/img/user/user-3.jpg" width="40" height="40" alt="" /></div>
							<div className="username">
				...
				<div className="timeline-item">
					...
					<div className="timeline-content">
						<div className="timeline-header">
							<div className="userimage"><Image src="/assets/img/user/user-4.jpg" width="40" height="40" alt="" /></div>
							<div className="username">
						...
						<div className="timeline-body">
							<div className="mb-3">
								...
								<div className="row gx-1">
									<div className="col-6">
										<a href="/assets/img/gallery/gallery-4.jpg" data-lity><Image src="/assets/img/gallery/gallery-4.jpg" width="1280" height="800" alt="" className="mw-100 h-auto d-block" /></a>
									</div>
									<div className="col-6">
										<a href="/assets/img/gallery/gallery-5.jpg" data-lity><Image src="/assets/img/gallery/gallery-5.jpg" width="1280" height="800" alt="" className="mw-100 h-auto d-block" /></a>
									</div>
								</div>
							</div>
