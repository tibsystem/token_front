...
export default function ExtraScrumBoard() {
	...
	return (
		<div className="app-content-padding" style={{minHeight: '100vh', backgroundImage: 'url(/assets/img/cover/cover-scrum-board.png)', backgroundRepeat: 'no-repeat', backgroundAttachment: 'fixed', backgroundSize: '360px', backgroundPosition: 'right bottom'}}>
