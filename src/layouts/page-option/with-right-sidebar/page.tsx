...
export default function PageOptionWithRightSidebar() {
	...
	useEffect(() => {
  	...
  	const { signal } = controller;
		const fetchData = async (index: number) => {
			try {
				const response = await fetch(`/assets/data/page-option/with-right-sidebar-code-${index}.json`, { signal });
	...
	return (
        ...
        <li className="breadcrumb-item"><Link href="/page-option/with-right-sidebar">Home</Link></li>
        <li className="breadcrumb-item"><Link href="/page-option/with-right-sidebar">Page Options</Link></li>
