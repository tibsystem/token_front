			...
			<div className="mailbox-sidebar">
				...
				<div className={'mailbox-sidebar-content collapse d-lg-block ' + (isMobileEmailNavOn ? 'show' : '') }>
					<PerfectScrollbar className="h-100" options={{suppressScrollX: true}}>
						...
						<ul className="nav nav-inbox">
							<li><Link href="/email/inbox"><i className="fa fa-fw fa-lg fs-12px me-2 fa-circle text-dark"></i> Admin</Link></li>
							<li><Link href="/email/inbox"><i className="fa fa-fw fa-lg fs-12px me-2 fa-circle text-blue"></i> Designer & Employer</Link></li>
							<li><Link href="/email/inbox"><i className="fa fa-fw fa-lg fs-12px me-2 fa-circle text-success"></i> Staff</Link></li>
							<li><Link href="/email/inbox"><i className="fa fa-fw fa-lg fs-12px me-2 fa-circle text-warning"></i> Sponsorer</Link></li>
							<li><Link href="/email/inbox"><i className="fa fa-fw fa-lg fs-12px me-2 fa-circle text-danger"></i> Client</Link></li>
						</ul>
					</PerfectScrollbar>
				</div>
			</div>
					...
					<PerfectScrollbar className="h-100" options={{suppressScrollX: true}}>
						<ul className="list-group list-group-lg no-radius list-email">
							<li className="list-group-item unread">
								...
								<Link href="/email/detail" className="email-user bg-blue">
							...
							<li className="list-group-item unread">
								...
								<Link href="/email/detail" className="email-user bg-indigo">
							...
							<li className="list-group-item unread">
								...
								<Link href="/email/detail" className="email-user bg-grey">
							...
							<li className="list-group-item">
								...
								<Link href="/email/detail" className="email-user">
									<Image src="/assets/img/user/user-12.jpg" width="30" height="30" alt="" />
								</Link>
								<div className="email-info">
									<Link href="/email/detail">
							...
							<li className="list-group-item">
								...
								<Link href="/email/detail" className="email-user">
									<Image src="/assets/img/user/user-1.jpg" width="30" height="30" alt="" />
								</Link>
								<div className="email-info">
									<Link href="/email/detail">
							...
							<li className="list-group-item">
								...
								<Link href="/email/detail" className="email-user">
									<Image src="/assets/img/user/user-13.jpg" width="30" height="30" alt="" />
								</Link>
								<div className="email-info">
									<Link href="/email/detail">
							...
							<li className="list-group-item">
								...
								<Link href="/email/detail" className="email-user">
									<Image src="/assets/img/user/user-14.jpg" width="30" height="30" alt="" />
								</Link>
								<div className="email-info">
									<Link href="/email/detail">
							...
							<li className="list-group-item">
								...
								<Link href="/email/detail" className="email-user">
									<Image src="/assets/img/user/user-2.jpg" width="30" height="30" alt="" />
								</Link>
								<div className="email-info">
									<Link href="/email/detail">
										<span className="email-sender">Gerald Huff</span>
							...
							<li className="list-group-item">
								...
								<Link href="/email/detail" className="email-user">
									<Image src="/assets/img/user/user-3.jpg" width="30" height="30" alt="" />
								</Link>
								<div className="email-info">
									<Link href="/email/detail">
										<span className="email-sender">Rick	Hopkins</span>
							...
							<li className="list-group-item">
								...
								<Link href="/email/detail" className="email-user">
									<Image src="/assets/img/user/user-4.jpg" width="30" height="30" alt="" />
								</Link>
								<div className="email-info">
									<Link href="/email/detail">
										<span className="email-sender">Jan Scott</span>
							...
							<li className="list-group-item">
								...
								<Link href="/email/detail" className="email-user">
									<Image src="/assets/img/user/user-5.jpg" width="30" height="30" alt="" />
								</Link>
								<div className="email-info">
									<Link href="/email/detail">
										<span className="email-sender">Nadine Barnes</span>
